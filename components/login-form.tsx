...
export function LoginForm({
    ...
    try {
      if (isLogin) {
        ...
        if (error) {
          ...
          setError(
            "Inscription réussie, veuillez vérifier votre email ou vous connecter."
          );
        }
      }
    } catch (err: any) {
  ...
  return (
    <div className=" w-full space-y-8 p-8 bg-white/94 backdrop-blur-sm rounded-xl shadow-2xl relative z-10">
